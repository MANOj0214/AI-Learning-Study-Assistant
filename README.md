...
NM ID: 396AF5DDEC0EB74BE58484785449934F
...
Initialize the vector store index and pre-load sample course materials.
Start the HTTP server at http://127.0.0.1:8000.
Open the web interface automatically in your browser.
...
Click on Gemini API Key in the top header.
Enter your API key (or set export GEMINI_API_KEY="your_api_key" in your terminal environment).
Click Save Settings.
